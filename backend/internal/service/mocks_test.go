...
func (m *mockUserRepo) FindByUsername(username string) (*model.User, error) { return m.findByUsernameFn(username) }
func (m *mockUserRepo) FindByEmail(email string) (*model.User, error) { return m.findByEmailFn(email) }
func (m *mockUserRepo) FindByAccount(account string) (*model.User, error) { return m.findByAccountFn(account) }
...
func (m *mockBadge) Leaderboard(limit int) ([]model.FulfillerStat, error) { return m.leaderboardFn(limit) }
...
func (m *mockWishRepo) FindByIDForUpdate(tx *gorm.DB, id uint64) (*model.Wish, error) { return m.findByIDForUpdateFn(tx, id) }
func (m *mockWishRepo) Update(wish *model.Wish) error { return m.updateFn(wish) }
func (m *mockWishRepo) UpdateWithTx(tx *gorm.DB, wish *model.Wish) error { return m.updateWithTxFn(tx, wish) }
func (m *mockWishRepo) Delete(id uint64) error { return m.deleteFn(id) }
func (m *mockWishRepo) List(filters map[string]any, sort string, offset, limit int) ([]model.Wish, error) { return m.listFn(filters, sort, offset, limit) }
func (m *mockWishRepo) Count(filters map[string]any) (int64, error) { return m.countFn(filters) }
func (m *mockWishRepo) ListByUserID(userID uint64, offset, limit int) ([]model.Wish, error) { return m.listByUserFn(userID, offset, limit) }
...
func (m *mockWishRepo) CountCompletedByFulfiller(userID uint64) (int64, error) { return m.countCompletedFn(userID) }
func (m *mockWishRepo) ListCompletedStories(offset, limit int) ([]model.Wish, error) { return m.listCompletedFn(offset, limit) }
func (m *mockWishRepo) TopFulfillers(limit int) ([]model.FulfillerStat, error) { return m.topFulfillersFn(limit) }
...
func (m *mockClaimRepo) CreateWithTx(tx *gorm.DB, claim *model.WishClaim) error { return m.createWithTxFn(tx, claim) }
func (m *mockClaimRepo) FindByID(id uint64) (*model.WishClaim, error) { return m.findByIDFn(id) }
func (m *mockClaimRepo) FindByWishID(wishID uint64) (*model.WishClaim, error) { return m.findByWishFn(wishID) }
func (m *mockClaimRepo) Update(claim *model.WishClaim) error { return m.updateFn(claim) }
func (m *mockClaimRepo) UpdateWithTx(tx *gorm.DB, claim *model.WishClaim) error { return m.updateWithTxFn(tx, claim) }
func (m *mockClaimRepo) ListByUserID(userID uint64, offset, limit int) ([]model.WishClaim, error) { return m.listByUserFn(userID, offset, limit) }
