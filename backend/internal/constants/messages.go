...
const (
	...
	MsgClaimSubmitted      = "送交成功，等待发布者验收"
	MsgClaimAccepted       = "验收通过，心愿已完成，徽章已发放"
	MsgClaimRejected       = "验收已驳回，心愿回到圆梦中"
	...
	MsgClaimSubmissionNote = "送交说明不能为空"
	MsgClaimUnderReview    = "心愿正在待验收期间，禁止更新进度或重复送交"
	MsgClaimNotUnderReview = "心愿不在待验收状态，无法验收"
	MsgClaimNotPublisher   = "只有心愿发布者才能验收"
	MsgRejectReason        = "驳回必须填写原因"
